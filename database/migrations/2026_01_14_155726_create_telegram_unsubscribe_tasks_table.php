...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('telegram_unsubscribe_tasks', function (Blueprint $table) {
            $table->id();
            $table->foreignId('telegram_account_id')->constrained('telegram_accounts')->onDelete('cascade')->index();
            ...
            $table->string('telegram_task_id')->nullable();
            $table->foreign('telegram_task_id')->references('id')->on('telegram_tasks')->onDelete('set null');
