<x-app-layout>
        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">
                    {{ __('Update service settings for manual mode.') }}
                </p>
            </div>
        ...
        <div class="max-w-[95%] mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 sm:p-8">
                    ...
                    <form method="POST"
                          action="{{ route('staff.services.update', $service) }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                    ...
                                    <div>
                                        <x-custom-select
                                            name="category_id"
                                            id="category_id"
                                            :value="old('category_id', (string) $service->category_id)"
                                            :label="__('Category') . ' *'"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="border border-gray-200 rounded-lg p-5 sm:p-6 bg-white shadow-sm"
                                 x-data="{
                                     mode: @js(old('mode', $service->mode ?? $defaultMode)),
                                     init() {
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <x-custom-select
                                            name="mode"
                                            id="mode"
                                            :value="old('mode', $service->mode ?? $defaultMode)"
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                <x-custom-select
                                                    name="service_type"
                                                    id="service_type"
                                                    :value="old('service_type', $service->service_type ?? 'default')"
                                            ...
                                            <div>
                                                <x-custom-select
                                                    ...
                                                    id="dripfeed_enabled"
                                                    :value="old('dripfeed_enabled', (string) (int) ($service->dripfeed_enabled ?? false))"
                                                    :label="__('Drip-feed')"
                                            ...
                                            <div>
                                                <x-custom-select
                                                    ...
                                                    id="user_can_cancel"
                                                    :value="old('user_can_cancel', (string) (int) ($service->user_can_cancel ?? false))"
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number"
                                                   name="rate_per_1000"
                                                   id="rate_per_1000"
                                                   value="{{ old('rate_per_1000', $service->rate_per_1000 ?? $service->rate ?? 0) }}"
                                                   required
                                                   min="0"
                                                   step="0.0001"
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number"
                                                   ...
                                                   value="{{ old('service_cost_per_1000', $service->service_cost_per_1000) }}"
                                                   min="0"
                                                   step="0.0001"
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="number"
                                               name="min_quantity"
                                               id="min_quantity"
                                               value="{{ old('min_quantity', $service->min_quantity ?? $service->min_order ?? 1) }}"
                                               required
                                               min="1"
                                    ...
                                    <div>
                                        ...
                                        <input type="number"
                                               name="max_quantity"
                                               id="max_quantity"
                                               value="{{ old('max_quantity', $service->max_quantity ?? $service->max_order ?? 1) }}"
                                               required
                                               min="1"
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <x-custom-select
                                                ...
                                                :value="old('deny_link_duplicates', (string) (int) ($service->deny_link_duplicates ?? false))"
                                        ...
                                        <div x-show="denyDuplicates === '1'" x-cloak class="transition-all">
                                            ...
                                            <input type="number"
                                                   ...
                                                   value="{{ old('deny_duplicates_days', $service->deny_duplicates_days ?? 90) }}"
                                                   min="1"
                                                   max="3650"
                                    ...
                                    <div>
                                        ...
                                        <input type="number"
                                               name="increment"
                                               id="increment"
                                               value="{{ old('increment', $service->increment ?? 0) }}"
                                               min="0"
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <x-custom-select
                                            ...
                                            :value="old('start_count_parsing_enabled', (string) (int) ($service->start_count_parsing_enabled ?? false))"
                                    ...
                                    <div x-show="parsingEnabled === '1'" x-cloak class="transition-all pt-4 border-t border-gray-200">
                                        <x-custom-select
                                            name="count_type"
                                            id="count_type"
                                            :value="old('count_type', $service->count_type)"
                                            :label="__('Count Type') . ' *'"
                                    ...
                                    <div>
                                        <x-custom-select
                                            ...
                                            :value="old('auto_complete_enabled', (string) (int) ($service->auto_complete_enabled ?? false))"
                            ...
                            <div class="border border-gray-200 rounded-lg p-5 sm:p-6 bg-white shadow-sm">
                                ...
                                <div>
                                    <x-custom-select
                                        name="refill_enabled"
                                        id="refill_enabled"
                                        :value="old('refill_enabled', (string) (int) ($service->refill_enabled ?? false))"
                            ...
                            <div class="border border-gray-200 rounded-lg p-5 sm:p-6 bg-white shadow-sm lg:col-span-2">
                                ...
                                <div>
                                    ...
                                    <textarea name="description"
                                              ...
                                              placeholder="{{ __('Write a short description for this service...') }}">{{ old('description', $service->description) }}</textarea>
                                    @error('description')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
    ...
    <script>
        function serviceEditForm() {
            return {
                denyDuplicates: @js(old('deny_link_duplicates', (string) (int) ($service->deny_link_duplicates ?? false))),
                parsingEnabled: @js(old('start_count_parsing_enabled', (string) (int) ($service->start_count_parsing_enabled ?? false))),
