        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                x-data="{
                    ...
                    previewVariant: '{{ old('preview_variant', 1) }}',
                    previewBadge: '{{ old('preview_badge', '') }}',
                    previewFeatures: @js(old('preview_features', [])),

                    planName: '{{ old('name', '') }}',
                    dailyPrice: '{{ old('prices.daily.price', '') }}',
                    monthlyPrice: '{{ old('prices.monthly.price', '') }}',
                    ...
                    toggleService(serviceId, serviceName) {
                        const index = this.selectedServices.findIndex(s => String(s.id) === String(serviceId));
                        if (index >= 0) {
                    ...
                    init() {
                        ...
                        if (initialCategory) {
                            this.categoryChanged(initialCategory);
                        }
            ...
            >
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white shadow-sm sm:rounded-lg">
                        <form method="POST" action="{{ route('staff.subscriptions.store') }}">
                            @csrf
                                ...
                                <div>
                                    ...
                                    <div x-show="selectedCategoryId">
                                        ...
                                        <div x-show="availableServices.length > 0">
                                            {{-- Multiselect Dropdown (with Select All) --}}
                    ...
                    <div class="sticky top-6">
                        ...
                        "
                                    >
                                        ...
                                        {{-- SWITCH OUTSIDE CARD (like screenshot) --}}
                                        ...
                                        <template x-if="previewVariant == 2">
                                            <div class="bg-blue-600 rounded-lg shadow-lg overflow-hidden relative">
                                             ...
                                             "></div>
                                                    ...
                                                    <template x-if="selectedServices.length > 0">
                                                        <div class="mb-6">
                                                            <div class="text-xs font-semibold text-blue-100 uppercase mb-2">
                                                                INCLUDED SERVICES
                                                            </div>
                                                            <ul class="space-y-2">
                                                                <template x-for="s in selectedServices" :key="s.id">
                                                                    <li class="flex items-center justify-between text-sm">
                                                                        ...
                                                                        <span class="text-blue-100 text-xs whitespace-nowrap">
                                                            x<span x-text="s.quantity"></span>
                                                        </span>
                                                                    </li>
                                                                </template>
                                                    ...
                                                    <template x-if="selectedServices.length === 0">
                                                        <div class="mb-6 text-sm text-blue-200">
                                                            No services selected yet.
                                                        </div>
                                                    </template>
                                        ...
                                        <template x-if="previewVariant == 3">
                                            <div class="bg-blue-900 rounded-lg shadow-lg overflow-hidden relative">
                                             ...
                                             "></div>
                                                    ...
                                                    <template x-if="selectedServices.length > 0">
                                                        <div class="mb-6">
                                                            <div class="text-xs font-semibold text-blue-200 uppercase mb-2">
                                                                INCLUDED SERVICES
                                                            </div>
                                                            <ul class="space-y-2">
                                                                <template x-for="s in selectedServices" :key="s.id">
                                                                    <li class="flex items-center justify-between text-sm">
                                                                        <span class="text-white truncate pr-2" x-text="s.name"></span>
                                                                        <span class="text-blue-200 text-xs whitespace-nowrap">
                                                            x<span x-text="s.quantity"></span>
                                                        </span>
                                                                    </li>
                                                                </template>
