...
<div class="grid grid-cols-2 gap-2">
    <div>
        <label for="{{ $minId }}" class="block text-sm font-medium text-gray-700 mb-1 whitespace-nowrap">
            {{ $minLabel }}
        </label>
        <input
            type="number"
    ...
    <div>
        <label for="{{ $maxId }}" class="block text-sm font-medium text-gray-700 mb-1 whitespace-nowrap">
            {{ $maxLabel }}
        </label>
        <input
            type="number"
