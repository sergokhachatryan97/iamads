...
//    ],
    ...
    'channel_subscribe' => [
        ...
        'allowed_link_kinds' => ['public_username', 'invite'],
        'allowed_peer_types' => ['channel'],
        'dropdown_label' => 'Channel and Group Lifetime Subscribers and Members',
        'dropdown_group' => 'Subscribers',
        'dropdown_priority' => 1,
        'requires_duration_days' => false,
        'requires_start_param' => false,
        'default_priority' => 60,
    ...
    'real_channel_subscribe_from_search' => [
        ...
        'allowed_peer_types' => ['channel'],
        'dropdown_label' => 'Subscribers From Search',
        'dropdown_group' => 'SubscribersSearch',
        'dropdown_priority' => 3,
        'requires_duration_days' => false,
        'requires_start_param' => false,
        'default_priority' => 60,
    ...
    'channel_subscribe_daily' => [
        ...
        'allowed_link_kinds' => ['public_username', 'invite'],
        'allowed_peer_types' => ['channel'],
        'dropdown_label' => 'Channel and Group Daily Subscribers and Members',
        'dropdown_group' => 'SubscribersDaily',
        'dropdown_priority' => 2,
        'requires_duration_days' => true,
        'requires_start_param' => false,
        'default_priority' => 60,
    ...
    'channel_post_views' => [
        ...
        'allowed_peer_types' => ['channel'],
        'dropdown_label' => 'Views',
        'dropdown_group' => 'Views',
        'dropdown_priority' => 6,
        'requires_duration_days' => false,
        'requires_start_param' => false,
        'default_priority' => 50,
    ...
    'channel_post_reactions' => [
        ...
        'allowed_link_kinds' => ['public_post'],
        'allowed_peer_types' => ['channel'],
        'dropdown_label' => 'Reactions',
        'dropdown_group' => 'Reactions',
        'dropdown_priority' => 5,
        'requires_duration_days' => false,
        'requires_start_param' => false,
        'default_priority' => 50,
    ...
    'channel_post_repost' => [
        ...
        'allowed_link_kinds' => ['public_post'],
        'allowed_peer_types' => ['channel'],
        'dropdown_label' => 'Repost / Forward',
        'dropdown_group' => 'RepostForward',
        'dropdown_priority' => 7,
        'requires_duration_days' => false,
        'requires_start_param' => false,
        'default_priority' => 50,
    ...
    'story_repost' => [
        ...
        'allowed_peer_types' => ['channel'],
        'dropdown_label' => 'Channel Story',
        'dropdown_group' => 'Story',
        'dropdown_priority' => 8,
        'requires_duration_days' => false,
        'requires_start_param' => false,
        'default_priority' => 50,
