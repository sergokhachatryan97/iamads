...
class InvitationController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('staff.invitations.create', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('staff.settings.invitations.show', $invitation)
            ->with('token', $token);
    }
    ...
    public function show(Invitation $invitation, Request $request): View|RedirectResponse
    {
        ...
        if (!$token) {
            return redirect()->route('staff.settings.invitations.index')
        ...
        $invitationLink = route('staff.invitation.accept', $token);

        return view('staff.invitations.show', [
